    ...
    return (
        <motion.div
            ...
            <div className='flex flex-col justify-center items-center gap-5'>
                <div className='flex gap-5 items-center max-w-[500px] lg:max-w-[1000px] min-h-[120px] lg:min-h-[140px] border px-5 lg:px-12 py-2 lg:py-9 rounded-2xl shadow-xl hover:border-sky-600 transition-all duration-300 hover:scale-105'>
