    ...
    return (
        <div className='absolute top-0 left-0 right-0 bottom-0 z-9 backdrop-blur-sm bg-black/50 flex justify-center items-center'>
            <form className='bg-slate-200 text-black border px-8 sm:px-12 py-5 sm:py-10 rounded-2xl'>
                <img className='relative top-0 left-72' src="/assets/cross_icon.svg" />
                ...
                <p className='mt-8  text-violet-700'>Forgot Password?</p>
                <button className='bg-blue-600 text-white px-32 py-2 mt-2 rounded-2xl hover:bg-blue-500'>Login</button>

                <p className='mt-5 text-red-600'>Don't have an account? <span className='text-blue-600 underline'>Sign up</span></p>
            </form>
        </div>
    )
}
